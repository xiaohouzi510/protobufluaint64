...
void protobuf_AssignDesc_test_2eproto() {
  ...
  SSInt64Test_descriptor_ = file->message_type(0);
  static const int SSInt64Test_offsets_[3] = {
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_HardType;
        break;
      }
...
void SSInt64Test::SerializeWithCachedSizes(
  ...
  // optional int32 HardType = 3;
  if (has_hardtype()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->hardtype(), output);
  }
...
::google::protobuf::uint8* SSInt64Test::SerializeWithCachedSizesToArray(
  ...
  // optional int32 HardType = 3;
  if (has_hardtype()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->hardtype(), target);
  }
